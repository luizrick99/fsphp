...
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
        <meta name="mit" content="2021-05-13T22:14:33-03:00+8724">
            ...
            <div class="container content">
                <section class="main_footer_content">
                    ...
                    <article class="main_footer_content_item social">
                        <h2>Social:</h2>
                        <a class="icon-facebook" target="_blank" href="https://www.facebook.com/<?= CONF_SOCIAL_FACEBOOK_PAGE; ?>" title="CafeControl no Facebook">/CafeControl</a>
                        <a class="icon-instagram" target="_blank" href="https://www.instagram.com/<?= CONF_SOCIAL_INSTAGRAM_PAGE; ?>" title="CafeControl no Instagram">@CafeControl</a>
                        <a class="icon-youtube" target="_blank" href="https://www.youtube.com/<?= CONF_SOCIAL_YOUTUBE_PAGE; ?>" title="CafeControl no YouTube">/CafeControl</a>
                    </article>
                </section>
            </div>
        </footer>
